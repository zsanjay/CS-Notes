...
// We can replace the function with the output. This is called "referential transperency"
...
// Further, no input state can be modified. That is, no data should be "mutated"
