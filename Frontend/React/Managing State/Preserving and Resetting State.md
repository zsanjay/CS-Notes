...
By default, React preserves state of a component while it stays at the same position. Usually, this is exactly what you want, so it makes sense as the default behavior. But sometimes, you want to reset a component's state. Consider this app that lets two players keep track of their scores during each turn:
...
#### 1. [Fix disappearing input text](https://react.dev/learn/preserving-and-resetting-state#fix-disappearing-input-text)
...
#### 2. [Swap two form fields](https://react.dev/learn/preserving-and-resetting-state#swap-two-form-fields)
...
#### 4. [Clear an image while it’s loading](https://react.dev/learn/preserving-and-resetting-state#clear-an-image-while-its-loading)
...
#### 5. [Fix misplaced state in the list](https://react.dev/learn/preserving-and-resetting-state#fix-misplaced-state-in-the-list)
